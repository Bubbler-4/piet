  ...
  constructor(code) {
    ...
    const loadFromPermalink = () => {
      ...
      try {
        ...
        setTimeout(1000, () => adjustHeight.call(jquery__WEBPACK_IMPORTED_MODULE_1___default()('#test-input').get(0)));
      } catch (err) {
        console.log(err);
      }
    };
